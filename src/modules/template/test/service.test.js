...
describe('TemplateService', () => {
  ...
  describe('createItem()', () => {
    ...
    it('should throw an error if item with same ID already exists', () => {
      service.createItem({ id: 'test1', name: 'Test 1' });
      expect(() => service.createItem({ id: 'test1', name: 'Duplicate' }))
        .to.throw('Item with ID test1 already exists');
    });
  });
  ...
  describe('updateItem()', () => {
    ...
    it('should throw an error if item does not exist', () => {
      expect(() => service.updateItem('nonexistent', { name: 'New Name' }))
        .to.throw('Item with ID nonexistent not found');
    });
  });
